<html dir="LTR" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:tool="http://www.microsoft.com/tooltip">
    <head>
        ...
        <title>2.4.4.6 ACCESS_ALLOWED_CALLBACK_ACE</title>
        <xml>
            <mshelp:toctitle title="2.4.4.6 ACCESS_ALLOWED_CALLBACK_ACE"></mshelp:toctitle>
            <mshelp:rltitle title="[MS-DTYP]: ACCESS_ALLOWED_CALLBACK_ACE"></mshelp:rltitle>
            <mshelp:keyword index="A" term="c9579cf4-0f4a-44f1-9444-422dfb10557a"></mshelp:keyword>
            <mshelp:attr name="DCSext.ContentType" value="open specification"></mshelp:attr>
            <mshelp:attr name="AssetID" value="c9579cf4-0f4a-44f1-9444-422dfb10557a"></mshelp:attr>
            <mshelp:attr name="TopicType" value="kbRef"></mshelp:attr>
            <mshelp:attr name="DCSext.Title" value="[MS-DTYP]: ACCESS_ALLOWED_CALLBACK_ACE" />
        </xml>
    </head>
    <body>
        <div id="header">
            <h1 class="heading">2.4.4.6 ACCESS_ALLOWED_CALLBACK_ACE</h1>
        </div>
        <div id="mainSection">
            <div id="mainBody">
...
<p>The ACCESS_ALLOWED_CALLBACK_ACE structure defines an ACE for
