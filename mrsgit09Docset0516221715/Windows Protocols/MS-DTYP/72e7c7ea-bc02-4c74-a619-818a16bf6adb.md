<html dir="LTR" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:tool="http://www.microsoft.com/tooltip">
    <head>
        ...
        <title>2.4.4.2 ACCESS_ALLOWED_ACE</title>
        <xml>
            <mshelp:toctitle title="2.4.4.2 ACCESS_ALLOWED_ACE"></mshelp:toctitle>
            <mshelp:rltitle title="[MS-DTYP]: ACCESS_ALLOWED_ACE"></mshelp:rltitle>
            <mshelp:keyword index="A" term="72e7c7ea-bc02-4c74-a619-818a16bf6adb"></mshelp:keyword>
            <mshelp:attr name="DCSext.ContentType" value="open specification"></mshelp:attr>
            <mshelp:attr name="AssetID" value="72e7c7ea-bc02-4c74-a619-818a16bf6adb"></mshelp:attr>
            <mshelp:attr name="TopicType" value="kbRef"></mshelp:attr>
            <mshelp:attr name="DCSext.Title" value="[MS-DTYP]: ACCESS_ALLOWED_ACE" />
        </xml>
    </head>
    <body>
        <div id="header">
            <h1 class="heading">2.4.4.2 ACCESS_ALLOWED_ACE</h1>
        </div>
        <div id="mainSection">
            <div id="mainBody">
...
<p>The ACCESS_ALLOWED_ACE structure defines an ACE for the
...
by a security identifier (SID).</p>
