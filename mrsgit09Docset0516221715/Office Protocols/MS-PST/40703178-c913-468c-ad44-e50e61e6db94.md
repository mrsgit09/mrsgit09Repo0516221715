...
<table>
 ...
 <tr>
  ...
  <p>Allocate space for the page (section <a href="d715d1ca-20e9-4966-b9b2-9cd36bd5f657.md">2.6.1.1.1</a>).</p>
  <p>The PAGETRAILER MUST be initialized (section <a href="f4ccb38a-930a-4db4-98df-a69c195926ba.md">2.2.2.7.1</a>).</p>
