<html dir="LTR" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:tool="http://www.microsoft.com/tooltip">
    <head>
        ...
        <title>2.296.4 BorderStyle.Right</title>
        <xml>
            <mshelp:toctitle title="2.296.4 BorderStyle.Right"></mshelp:toctitle>
            <mshelp:rltitle title="[MS-RDL]: BorderStyle.Right"></mshelp:rltitle>
            <mshelp:keyword index="A" term="9377cf41-6f94-40d1-8ab1-f8dacd29173d"></mshelp:keyword>
            <mshelp:attr name="DCSext.ContentType" value="open specification"></mshelp:attr>
            <mshelp:attr name="AssetID" value="9377cf41-6f94-40d1-8ab1-f8dacd29173d"></mshelp:attr>
            <mshelp:attr name="TopicType" value="kbRef"></mshelp:attr>
            <mshelp:attr name="DCSext.Title" value="[MS-RDL]: BorderStyle.Right" />
        </xml>
    </head>
    <body>
        <div id="header">
            <h1 class="heading">2.296.4 BorderStyle.Right</h1>
        </div>
        <div id="mainSection">
            <div id="mainBody">
...
<p>The <b>BorderStyle.Right</b> element specifies the style of
a right border. This element is optional. If this element is present, its value
...
<p>If the <b>BorderStyle.Right</b> element is not present, its
value is interpreted as &quot;None&quot;.</p>

<p>Following is the parent element of the <b>BorderStyle.Right</b>
element.</p>
...
<p>The following is the XML Schema definition of the <b>BorderStyle.Right</b>
element.</p>
