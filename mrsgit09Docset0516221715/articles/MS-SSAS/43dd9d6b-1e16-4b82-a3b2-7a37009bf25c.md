<html dir="LTR" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:tool="http://www.microsoft.com/tooltip">
    <head>
        ...
        <title>4.4.1 Client Sends Request</title>
        <xml>
            <mshelp:toctitle title="4.4.1 Client Sends Request"></mshelp:toctitle>
            <mshelp:rltitle title="[MS-SSAS]: Client Sends Request"></mshelp:rltitle>
            <mshelp:keyword index="A" term="43dd9d6b-1e16-4b82-a3b2-7a37009bf25c"></mshelp:keyword>
            <mshelp:attr name="DCSext.ContentType" value="open specification"></mshelp:attr>
            <mshelp:attr name="AssetID" value="43dd9d6b-1e16-4b82-a3b2-7a37009bf25c"></mshelp:attr>
    ...
    <body>
        <div id="header">
            <h1 class="heading">4.4.1 Client Sends Request</h1>
        </div>
        <div id="mainSection">
            <div id="mainBody">
